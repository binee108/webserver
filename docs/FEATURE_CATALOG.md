...
- **orphan-order-prevention** - 고아 주문 방지 통합 솔루션 (Phase 3a: market_type 정확도, Phase 1-2: DB 재시도 + 취소 실패 추적) [`@COMP:service,config,model`] → [docs](features/orphan-order-prevention.md)
