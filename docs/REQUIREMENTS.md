...
| 전략 손익 반영 | 전략별 손익이 해당 전략 자산만 증감 | ⚠️ (성과 추적 시스템 존재, 자본 자동 반영은 선택적) |
...
- **손익 반영**: ⚠️ 선택적 구현
  - 현재 `StrategyPerformance` 시스템으로 성과 추적 완료 (Priority 3)
  - 손익의 자본 자동 반영은 추가 개발 필요 (복리 효과 구현 시)
...
3. ~~**자산 재배분 자동화**~~ ✅ **완료됨** (Priority 4 - 2025-10-03)
   ...
   - ✅ 자동 리밸런싱 스케줄러 (매시 17분)
   - ⚠️ 전략별 손익 자본 반영은 선택적 (성과 추적 시스템 존재)
...
**기준 코드베이스**: Priority 1-4 완료 (전략 격리, 자본 재배분, 성과 분석, 자동 리밸런싱)
**주요 변경사항**:
